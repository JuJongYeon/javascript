...
<body>
    ...
    -->
        ...
        <div class="main-panel" style='background-image:url("assets/img/background/desk.jpg");max-width: 100%; height: auto; '>
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <c:forEach var = "searchlist" items = "${keyword}" >
                                                <tr>
                                                    <td height="50" width="100"><img class="photo" src="/Semi_Project/imageUpload/${searchlist.image }"  alt="강의등급이미지"></td>
