                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">${memberInfo.NAME}님 -
                                        <small class="category">Modify profile</small>
                                    </h4>
                                    <form action="Admin_MemberAlter.se" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                              <div class="form-group label-floating">
                                                 <p ><label class="control-label "><h5 class="text-danger">회원번호</h5></label></p>
                                                  <input type="hidden" class="form-control" name="num" value="${memberInfo.MEMBERNUM}">
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <p ><label class="control-label "><h5 class="text-info">아이디</h5></label></p>
                                                     
                                                    <input type="text" class="form-control" name="id" value="${memberInfo.ID}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                   <p ><label class="control-label "><h5 class="text-info">이름</h5></label></p>
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <p ><label class="control-label "><h5 class="text-info">나이</h5></label></p>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                     <p ><label class="control-label "><h5 class="text-info">성별</h5></label></p>
                                                     <input type="text" class="form-control" name="gender" value="${memberInfo.GENDER}" >
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <input type="submit" class="btn btn-rose pull-right" value="프로필 수정" onclick="return confirm('회원 정보를 수정하시겠습니까?');">
