                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="wizard-container">
                            <div class="card wizard-card" data-color="rose" id="wizardProfile">
                                <form action="MemberLoginAction.se" method="post" name="MemberLoginForm">
                                                
                                    <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
                                    <div class="wizard-header">
                                    <div class="alert alert-rose" style='text-align:center'>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                    <h4 class="info-text"> 아이디, 비밀번호를 입력해주세요. </h4>
                                                </div>
                                    ...
                                    <div class="wizard-footer">
                                        <div class="pull-right">
                                            <input type='submit' class='btn btn-fill btn-rose btn-wd' name='Login' value='로그인' />
                                         </div>
