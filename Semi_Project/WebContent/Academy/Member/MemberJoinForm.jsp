                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="wizard-container">
                            <div class="card wizard-card" data-color="rose" id="wizardProfile">
                                <form action="MemberJoinAction.se" method="post" name="MemberJoinForm">
                                    ...
                                    <div class="wizard-navigation">
                                        <ul>
                                            <li>
                                               <a href="#about" data-toggle="tab">기본정보</a>
                                            </li>
                                            <li>
                                                <a href="#address" data-toggle="tab">상세정보</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="tab-content">
                                        <div class="tab-pane" id="about">
                                            <div class="row">
                                                <h4 class="info-text">아이디, 비밀번호, 이메일주소를 입력해주세요.</h4>
                                                <div class="col-lg-10 col-lg-offset-1">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">아이디
                                                                <small>(required)</small>
                                                            </label>
                                                            <input name="id" type="text" class="form-control" required="required">
                                                            <input type="button" class="btn btn-rose btn-wd" name="confirm_id" onclick="confirmId(this.form)" value="ID 중복확인" >
                                                            
                                                            <script type="text/javascript">
                        									function confirmId(){
                        									if(document.MemberJoinForm.id.value == ""){
                        									alter("Id");
                        									return;
                        									}
                        										url = "Academy/Member/confirmId.jsp?id="+document.MemberJoinForm.id.value;
                        										open(url, "confirm",
                                        ...
                                        <div class="tab-pane" id="address">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <h4 class="info-text"> 상세정보 입력란 입니다. </h4>
                                                </div>
                                                <div class="col-lg-10 col-lg-offset-1">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                ...
                                                <div class="col-lg-10 col-lg-offset-1">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">전화번호
                                                                <small>(required)</small>
                                                            </label>
                                                ...
                                                <div class="col-lg-10 col-lg-offset-1">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">성별
                                                                <small>(required)</small>
                                                            </label>
                                                            <input name="gender" type="radio" required="required" value="남성">남성
                                                            <input name="gender" type="radio" required="required" value="여성">여성
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
