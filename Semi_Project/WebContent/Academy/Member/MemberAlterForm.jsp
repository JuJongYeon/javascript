                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">내 프로필 수정 -
                                        <small class="category">Modify profile</small>
                                    </h4>
                                    <form action="MemberAlter.se" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <p ><label class="control-label "><h5 class="text-danger">Academy</h5></label></p>
                                                    <input type="text" class="form-control" value="ICIA" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                              <div class="form-group label-floating">
                                                 <p ><label class="control-label "><h5 class="text-danger">회원번호</h5></label></p>
                                                  <input type="hidden" class="form-control" name="num" value="${memberInfo.MEMBERNUM}" disabled>
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <p ><label class="control-label "><h5 class="text-danger">아이디</h5></label></p>
                                                     <p class="form-control">${memberInfo.ID}</p>
                                                    <input type="hidden" class="form-control" name="id" value="${memberInfo.ID}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <p ><label class="control-label "><h5 class="text-info">비밀번호</h5></label></p>
                                                    <input type="text" class="form-control" name="pass" value="${memberInfo.PASS}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                   <p ><label class="control-label "><h5 class="text-danger">이름</h5></label></p>
                                                     <p class="form-control">${memberInfo.NAME}</p>
                                                    <input type="hidden" class="form-control" name="name" value="${memberInfo.NAME}" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                     <p ><label class="control-label "><h5 class="text-info">이메일 주소</h5></label></p>
                                                    <input type="email" class="form-control" name="email" value="${memberInfo.EMAIL}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                     <p ><label class="control-label "><h5 class="text-info">전화번호</h5></label></p>
                                                    <input type="text" class="form-control" name="phone" value="${memberInfo.PHONE}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <p ><label class="control-label "><h5 class="text-danger">나이</h5></label></p>
                                                     <p class="form-control">${memberInfo.AGE}</p>
                                                	<input type="hidden" class="form-control" name="age" value="${memberInfo.AGE}" >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                     <p ><label class="control-label "><h5 class="text-danger">성별</h5></label></p>
                                                     <p class="form-control">${memberInfo.GENDER}</p>
                                                    <input type="hidden" class="form-control" name="gender" value="${memberInfo.GENDER}" >
                                                </div>
                                            </div>
                                        </div>
                                       
                                        <input type="submit" class="btn btn-rose pull-right" value="프로필 수정 완료" onclick="return confirm('내 프로필 정보를 수정하시겠습니까?');">
