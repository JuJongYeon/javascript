...
function checkcategory(){
    if (AddPlayList.category_select.value == '1') {
        AddPlayList.category.readOnly = false;
        AddPlayList.category.value = '';
        AddPlayList.category.focus();
    }
    else {
        AddPlayList.category.readOnly = true;
        AddPlayList.category.value = AddPlayList.category_select.value;
    }
}
function checklecture_level(){
    if (AddPlayList.lecture_level_select.value == '1') {
        AddPlayList.lecture_level.readOnly = false;
        AddPlayList.lecture_level.value = '';
        AddPlayList.lecture_level.focus();
    }
    else {
        AddPlayList.lecture_level.readOnly = true;
        AddPlayList.lecture_level.value = AddPlayList.lecture_level_select.value;
    }
}
</script>    
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <form name="AddPlayList" action="AddPlayList.ac" method="post" enctype="multipart/form-data">
