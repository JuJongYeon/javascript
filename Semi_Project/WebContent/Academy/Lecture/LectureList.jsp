			...
			<div class="content" >
				<div class="container-fluid">
					...
					<div class="col-md-4">
                            ...
                            <!-- 이미지 클릭시 해당 강의의 챕터 목록을 불러오는 과정을 위해 playChapterListAction.ac로 이동한다 -->
                            <a href="playChapterListAction.ac?lecture_level=${list.lecture_level }&category=${list.category }&id=<%=session.getAttribute("id") %>&lecture_image=${list.lecture_image }">
                                <div class="card-image" data-header-animation="true">
                                   <img class="img" src="/Semi_Project/imageUpload/${list.lecture_image }">
                                </div>
                                 </a>
                                <div class="card-content">
                                    ...
                                    <h4 class="card-title">
                                    <!-- 강의 등급 클릭시 해당 강의의 챕터 목록을 불러오는 과정을 위해 playChapterListAction.ac로 이동한다 -->
                                        <a href="playChapterListAction.ac?lecture_level=${list.lecture_level }&category=${list.category }&id=<%=session.getAttribute("id") %>&lecture_image=${list.lecture_image }" class="text-info"><h4 >(${list.category })
												${list.lecture_level }</h4></a>
                                    </h4>
                                ...
                                <div class="card-footer">
									<div class="stats">
										<i class="material-icons text-info">info</i> <a href="#pablo">챕터
											목록 보기</a>
									</div>
								</div>
                            </div>
