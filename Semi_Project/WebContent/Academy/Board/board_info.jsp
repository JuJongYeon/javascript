...
<%@ page import="action.BoardViewAction" %>
    ...
    -->
           	...
           	<div class="row">
                <table class = "table table-striped" style="text-align: center ;border:1px solid #dddddd">
                   <thead>
                    ...
                    <a href = "alter_board.bo?id=${sub.BOARD_NUM}&page=<%= nowPage%>&boardnum=${sub.BOARD_NUM}" class="btn btn-primary pull-right">수정</a>
             	    <a href = "boardDelete.bo?id=${sub.BOARD_NUM}&page=<%= nowPage%>&boardnum=${sub.BOARD_NUM}" class="btn btn-primary pull-right">삭제</a>
             	    <a href = "boardList.bo?id=${sub.BOARD_NUM}&page=<%= nowPage%>&boardnum=${sub.BOARD_NUM}" class="btn btn-primary pull-right">목록</a>
                   ...
                   <tbody>
                          <tr>
                               ...
                               <td colspan="2" style="background-color:#F6F6F6; color:black;text-align:left">${sub.BOARD_SUBJECT}</td>
                         </tr>
                          <tr>
                               <td style="background-color:#F6F6F6;">작성자</td>
                               <td colspan="2" style="background-color:#F6F6F6;color:black;text-align:left">${sub.BOARD_NAME}</td>
                          </tr>
                          <tr>
                               <td style="background-color:#F6F6F6;">작성일자</td>
                               <td colspan="2" style="background-color:#F6F6F6;color:black;text-align:left">${sub.BOARD_DATE}</td>
                          </tr>
                           <tr>
                               <td style="background-color:#F6F6F6;color:black">내용</td>
                               <td colspan="2" style= "min-height: 200px; text-align:left; background-color:#F6F6F6;">${sub.BOARD_CONTENT}</td>
                           </tr>  
                  </tbody>
        ...
        <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <button class="show-comments btn btn-default btn-lg btn-block"> View comments <span class="disqus-comment-count" data-disqus-url="http://apkupdate.com/"></span></button> 
...
var disqusFunction = function () {
    ...
    $.ajax({
        type: "GET",
        url: "https://semiproject.disqus.com/embed.js",
        dataType: "script",
        cache: true
    });
