   ...
   <div class="wrapper">
    ...
    -->
        ...
        <div class="main-panel" >
            ...
            <div class="content">
           	<div class="row">
                 <form action="boardAlterAction.bo" method="post">
                <table class = "table table-striped" style="text-align: center ;border:1px solid #dddddd">
                  ...
                  <tr>
                        <!-- 제목 -->
                       <td><input type="text" class="form-control" placeholder="글제목" name="BOARD_SUBJECT" maxlenght="200" value="${sub.BOARD_SUBJECT}"></td>
                  </tr>
                    <tr>
                           <!-- 내용 -->
                          <td><textarea type="type" class="form-control" placeholder="글내용" name="BOARD_CONTENT" maxlenght="2000" style="height:350px;">${sub.BOARD_CONTENT}</textarea></td>
                   </tr>
                  </tbody>

                </table>
                <input type="hidden" value="${sub.BOARD_NUM}" name="boardnum">
                <input type="hidden" value ="${sub.BOARD_NAME}" name ="boardname">
