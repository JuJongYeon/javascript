...
<body>
   <div class="wrapper">
    ...
    -->
        ...
        <thead>
           <tr>
              <th colspan="1" style="background-color:#eeeeee;text-align:center;" >게시판 글쓰기</th>
           </tr>
        </thead>
        ...
        <tbody>
           <tr>
           <!-- 제목 -->
              <td><input type="text" class="form-control" placeholder="글제목" name="BOARD_SUBJECT" maxlenght="200"></td>
          </tr>
          <tr>
          <!-- 내용 -->
          
            <td><textarea  type="text" class="form-control" placeholder="글내용" name="BOARD_CONTENT" maxlenght="2000" style="height:350px;"></textarea></td>
          </tr>
        </tbody>
        </table>
