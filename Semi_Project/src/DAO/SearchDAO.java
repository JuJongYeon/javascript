	...
	public ArrayList<SearchBean> selectSearchList(String keyword) {
		...
		try {
			...
			while(rs.next()) {
				...
				System.out.println(searchInfo.getNum());
				System.out.println("3");
				System.out.println(searchInfo.getCategory());
				System.out.println("4");
				System.out.println(searchInfo.getLecture());
				System.out.println("5");
				System.out.println(searchInfo.getUrl());
